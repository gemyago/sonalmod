...
**IMPORTANT** AI must orchestrate the implementation, not implement or do any other work anything itself, this is a job of sub-agents. AI must only read relevant filesand then start sub-agents, that's it!
...
As a first step please build a TODO for for yourself to orchestrate implementation.
...
- Verification succeeded after fix: yes
